...
using HSNXT.DSharpPlus.VoiceNative;
...
namespace DSharpPlus.VoiceNext
{
    ...
    {
        private readonly AudioSender _audioSender = new AudioSender();
        ...
        public async Task<VoiceNextConnection> ConnectAsync(DiscordChannel channel)
        {
            ...
            var vnc = new VoiceNextConnection(this.Client, gld, channel, this.Configuration, vsrup, vstup, _audioSender);
